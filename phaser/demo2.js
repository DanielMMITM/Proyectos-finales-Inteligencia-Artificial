...
function update() {
    velocidadBala2 = bala2.body.velocity.y; //SE AGREGO
    ...
    if (modoAuto == false && bala.position.x > 0) {
		...
		console.log(
			`Bala 1: ${despBala}, Bala 1 Velocidad: ${velocidadBala}, Estatus Aire: ${estatusAire}, Bala 2: ${despBala2}, Bala 2 velocidad: ${velocidadBala2}, EstatusIzquierda: ${estatusLeft}, EstatusDerecha: ${estatusRight}`
		);
	}
}
